...
$connection = new mysqli($servername, $username, $message, $database);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        if (empty($name) || empty($phone) || empty($person) || empty($reservation_date) || empty($reservation_time) || empty($message)) {
    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="date" class="form-control" name="reservation_date" value="<?php echo $reservation_date ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="time" class="form-control" name="reservation_time" value="<?php echo $reservation_time ?>">
                </div>
            </div>
